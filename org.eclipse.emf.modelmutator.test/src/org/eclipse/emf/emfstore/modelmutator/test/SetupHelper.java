...
import org.eclipse.emf.emfstore.modelmutator.test.server.integration.IntegrationTestHelper;
...
public class SetupHelper {
	 ...
	 * @return acorgunitid the unit id
	 * @throws EmfStoreException in case of failure
	 * @throws InvalidInputException in case of failure with user already exists
	 */
